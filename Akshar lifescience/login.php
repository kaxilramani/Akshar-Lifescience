						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="moorem" name="moorem" placeholder="Email id or Mobile Number" autocomplete="off" required data-error="Please enter your email">
