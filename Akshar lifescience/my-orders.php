...
if(isset($_GET["cancel"])){
    ...
    mysqli_query($con, "UPDATE `orders` SET `o_status` = '4' WHERE `o_id` = $oid AND `o_status` = 1");
...
<div class="container">
    ...
    <div class="row pb-5">
        <div class="col-12">
            ...
            $ord_res = mysqli_query($con, "SELECT * FROM `orders` WHERE `o_status` != 0 AND `o_user` = '$user_id' ORDER BY `o_id` DESC LIMIT 10");
                            ...
                            <div class="col-lg-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-6 my-auto">
                                        ...
                                        <h2 class="font-weight-bold pb-0"><?php echo $order_status_list[$ord["o_status"]]; ?></h2>
                                    </div>
                                    <div class="col-lg-4 my-auto">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 <?php if ($ord["o_status"] == "1") {
                                                ...
                                                <!-- <button class="btn btn-success btn-block" onclick="location.href='payment/pay.php?order=<?php echo $ord['o_id']; ?>'">Payment</button> -->
                                            </div>
                                            <?php
                                            if ($ord["o_status"] == "1") {
                                            ?>
