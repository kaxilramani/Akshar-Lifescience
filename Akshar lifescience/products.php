		...
		<div class="row px-2">
			<div class="col-12 px-4">
				<div class="row font-weight-bold py-2 border border-secondary rounded">
					...
					<div class="col-md-3 col-12 form-group">
						<label style="user-select: none;" class="text-white d-md-block d-none">Filter Now : </label>
						<button type="button" class="btn btn-secondary btn-block btn-lg" onclick="location.href='products.php?page=1&cat=0&cmp=0'">Reset</button>
					</div>
				</div>
			</div>
		</div>
			...
			?>
				<div class="col-lg-4 col-md-6 col-sm-12 h-100 ">
					<div class="blog-inner border border-secondary rounded mb-md-4 mb-4">
						<div class="blog-img">
							<img class="img-fluid" src="public/images/medicines/<?php print_not_empty($med["m_img"]); ?>" alt="" />
						</div>
						...
						<a href="?page=1&cmp=<?php echo $med["cmp_id"]; ?>" class="p-0 cmp-link"><?php echo $med["cmp_name"]; ?></a>
						<div class="row p-3">
